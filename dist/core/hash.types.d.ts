 ...
 */
export interface THash<IBufferLike extends TBufferLike = TBufferLike> {
    /**
     ...
     * @param msg -
     */
    sha3_256(msg: TBufferLikeInput): IBufferLike;
    /**
     * This function hash the provided message using the
     ...
     * @param msg -
     */
    sha256(msg: TBufferLikeInput): IBufferLike;
    /**
     * This function hash the provided message using the
     ...
     * @param msg -
     */
    sha512(msg: TBufferLikeInput): IBufferLike;
    /**
     * This function is going to hash a message using
     * sha3 256 bits (= 32 bytes) keccak algorithm.
     *
