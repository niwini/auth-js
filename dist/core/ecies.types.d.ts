...
export interface TCipherParams<IBufferLike extends TBufferLike = TBufferLike> {
 ...
 */
export interface TECIES<IBufferLike extends TBufferLike = TBufferLike> {
    /**
     ...
     */
    encrypt(msg: TBufferLikeInput, pubKey: TBufferLikeInput): TCipherParams<IBufferLike> & {
        toHex(): string;
    };
    /**
