...
export type TBufferLikeInput = string | Object | Buffer | Uint8Array | TBufferLike;
/**
...
export interface TBufferLikeClass {
     ...
     */
    new (data: TBufferLikeInput, encoding?: BufferEncoding): TBufferLike;
    /**
     ...
     * @param encoding - Encoding to use when data is string.
     */
    cast(data: TBufferLikeInput, encoding?: BufferEncoding): TBufferLike;
    /**
     * Creates a new buffer like.
     *
     * @param data - Data to be converted.
     * @param encoding - Encoding to use when data is string.
     */
    from(data: TBufferLikeInput, encoding?: BufferEncoding): TBufferLike;
    /**
